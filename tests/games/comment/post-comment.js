module.exports = [
  ...
  {
    section: "essential",
    endpoint: "/api/reviews/1/comments",
    method: "post",
    body: { username: "bainesface", body: "this is a comment" },
  ...
  },
  {
    ...
    makeAssertion: (res, expect) => {
      ...
      expect(res.body.comment.author).to.equal("bainesface");
  ...
  {
    section: "essential",
    endpoint: "/api/reviews/10000/comments",
    method: "post",
    body: { username: "bainesface", body: "this is a comment" },
    makeAssertion: (res, expect) => {
  ...
  {
    section: "essential",
    endpoint: "/api/reviews/not-a-valid-id/comments",
    method: "post",
    body: { username: "bainesface", body: "this is a comment" },
    makeAssertion: (res, expect) => {
      expect(res.status).to.equal(400);
